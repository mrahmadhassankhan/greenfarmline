    ...
    <>
      <footer className="footer bg-gray-200 text-black dark:bg-slate-600 dark:text-white p-10">
        <nav>
          ...
          <a className="link link-hover" href="/image-detection">Crop Disease Detection</a>
        </nav>
        <nav>
      ...
      <footer className="footer bg-gray-200 text-black border-gray-300 dark:border-black dark:bg-slate-600 dark:text-white border-t px-10 py-4">
