...
import MuzzamilKhanImage from '../../../../public/images/team/Muzzamil Khan.png'
import HassanKhanImage from '../../../../public/images/team/Hassan Khan.png'
const teamMembers = [
        ...
        <div className="flex justify-around">
          {teamMembers.map((member, idx) => (
            <div key={idx} className="w-1/3 px-4">
              <img src={member.image} alt={member.name} className="w-48 h-48 rounded-full object-cover mx-auto shadow-2xl bg-lime-500" />
