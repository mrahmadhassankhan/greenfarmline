...
const QueryDetailsCard = ({ title, description, author, date, image, status, onClick }) => {
    ...
    return (
        <div 
            onClick={onClick} 
            className="relative h-fit flex flex-col dark:bg-slate-900 dark:border md:flex-row items-start bg-white shadow-lg rounded-lg p-4 hover:shadow-xl transition-shadow cursor-pointer"
        >
            {image && (
                <img
                    src={image}
