...
const Content = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-10 md:px-20 mt-20">
                ...
                {faqData.map((faq, index) => (
                    <div key={index} className="mb-4 border-b border-gray-200 pb-4">
                        <button
                            ...
                            className="w-full text-left text-lg font-semibold text-gray-800 hover:text-lime-500 focus:outline-none transition-colors duration-300"
                        >
                            {faq.question}
                        </button>
                        {openIndex === index && (
