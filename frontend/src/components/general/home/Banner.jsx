                ...
                <div className='w-full md:w-1/2 order-2 md:order-1 mt-12 md:mt-32'>
                    <div className='space-y-12'>
                        ...
                        <p className='text-l text-justify'>
                            Green Farm Line brings cutting-edge solutions to the agricultural sector, offering a seamless platform for purchasing essentials, expert advice, and advanced crop disease detection. <span className='text-lime-500 font-bold'>Grow better, harvest smarter.</span>
                        </p>
                    </div>
                    <div className='flex justify-center items-center md:justify-normal'>
                        <button className="bg-lime-500 text-white p-2 mt-6 rounded-md hover:bg-lime-600 duration-200 cursor-pointer">Get Started</button>
                    </div>
                </div>
