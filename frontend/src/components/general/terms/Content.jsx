...
function Content() {
    return (
        <>
            <div className="container mx-auto md:px-20 px-4 mt-28">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-4">3. User Obligations</h2>
                <p className="text-lg text-gray-600 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-4">4. Service Description</h2>
                <p className="text-lg text-gray-600 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-4">7. User-Generated Content</h2>
                <p className="text-lg text-gray-600 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-4">9. Termination of Use</h2>
                <p className="text-lg text-gray-600 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-4">10. Amendments and Updates</h2>
                <p className="text-lg text-gray-600 mb-6">
