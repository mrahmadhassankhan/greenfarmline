    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex justify-center items-center mt-10">
        <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-lg">
          <h2 className="text-2xl font-semibold text-center text-gray-800 mb-4">Your Profile</h2>
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-700"><strong>Phone:</strong> {profile.phoneNumber || "N/A"}</p>
            ...
            {profile.role === "seller" && (
              <>
                ...
                <p className="text-gray-700"><strong>Registration No:</strong> {profile.registrationNo}</p>
              </>
            )}
            ...
            {profile.role === "expert" && (
              <>
                <p className="text-gray-700"><strong>Qualification:</strong> {profile.qualification}</p>
                <p className="text-gray-700"><strong>Experience:</strong> {profile.yearsOfExperience} years</p>
